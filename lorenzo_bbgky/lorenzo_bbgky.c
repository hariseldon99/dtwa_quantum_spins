...
//			    0.0, smat_mf);
  ...
  //for (g = 0; g < 3; g++)
	...
	//{
	  ...
	  //cmat_mf_gplus3b = gsl_matrix_row (&cmat_mf.matrix, g + 3 * b);

	  //Reshape view to a matrix
	  //c_gplus3b_mat =
	    //gsl_matrix_view_vector (c_gplus3b, latsize, latsize);
	  //cmat_mf_gplus3b_mat =
	    //gsl_matrix_view_vector (cmat_mf_gplus3b, latsize, latsize);
