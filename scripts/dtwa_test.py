...
def run_dtwa():
    ...
    for alpha in alphas:
        ...
        d = dtwa.Dtwa_BBGKY_Lindblad_System(p, comm, n_t=niter, seed_offset = 0, decoherence=(0.5, 0.5, 0.5), verbose=True)
        ...
        if rank == 0:
            ...
            append_all = "_time_alpha_" + str(alpha) + "_N_"+str(lattice_size)+"_2ndorder.txt"
